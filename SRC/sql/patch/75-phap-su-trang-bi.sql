...
--
-- Tổng số dòng option sau khi chạy phải là 252 (TRẦN LÀ 255).
...
DELETE FROM `item_option_template` WHERE `id` BETWEEN 251 AND 257;   -- dọn cả dải cũ nếu đã lỡ chạy bản trước

-- (1) MỘT dòng duy nhất: cái tem đếm số lần đã pháp sư.
--
