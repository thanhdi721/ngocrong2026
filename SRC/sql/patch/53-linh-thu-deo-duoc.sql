...
-- Chạy cùng jar đã thêm 6 dòng trong Player.sendNewPet(). Chạy lại vẫn an toàn.
...
SELECT `id`, `NAME`, `TYPE`, `part`, `head`, `body`, `leg` FROM `item_template` WHERE `id` BETWEEN 2114 AND 2119;
